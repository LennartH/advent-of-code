...
describe('Day 13: Point Of Incidence', () => {
  describe('Example input', () => {
    const input = `
      ...
      #....#..#
    `;
    const part1Solution = 405;
    const part2Solution = 400;
  ...
  describe('Additional example input', () => {
    const input = `
      #.##..##.
      ..#.##.#.
      ##......#
      ...
      #.#.##.#.
    `;
    const part1Solution = 709;
    const part2Solution = 1400;
  ...
  describe('Real input', () => {
    ...
    const part1Solution = 29130;
    const part2Solution = 33438;
